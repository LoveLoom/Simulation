const questions = [
  {
    question: "تتيح لك المنصة استخدام لغات برمجة منها",
    options: ["Html", "JavaScript", "Blocks", "2&3"],
    answer: "2&3",
  }, // question 1
  {
    question: "الجزء الايمن من المنصة مسؤول عن",
    options: [
      "الضغط ع الكائن",
      "ادراج الكود بداخله عند إدخال اي كائن على المنصة",
      "حذف الكائن",
      "التعديل على الكائن",
    ],
    answer: "ادراج الكود بداخله عند إدخال اي كائن على المنصة",
  }, // question 2
  {
    question: "عند فتح code يتيح لك التعامل مع الكائن من حيث",
    options: [
      "ادراجه ",
      "التعديل عليه",
      "الدورات عكس عقارب الساعة فقط",
      "تغيير مساره",
    ],
    answer: "تغيير مساره",
  }, // question 3
  {
    question: " مسئولة عن وجود الكائن بشكل دائم قائمة ",
    options: ["panel", "Training", "controls ", "Transform "],
    answer: "controls ",
  }, // question 4
];
let index = 0;
