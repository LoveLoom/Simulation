const questions = [
  {
    question: " يشترط في التسجيل لأول مرة تحديد ما اذا كنت طالب ام معلم",
    options: ["True", "False", "", ""],
    answer: "True",
  }, // question 1
  {
    question: "تتيح لنا المنصة عمل",
    options: ["واقع معزز (VR)", "واقع افتراضي (AR)", "MERGE CUBE", "جميعهم"],
    answer: "جميعهم",
  }, // question 2
  {
    question: "التطبيقات الرئيسية التي تنشيئها منصة Cospace",
    options: [
